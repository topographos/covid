...
```{r eval=FALSE, fig.align='right', message=FALSE, warning=FALSE, include=FALSE, paged.print=FALSE}
#produce animation
...
*'Historical'* cases up to 18th March come from `fantastic` work by [Tom White](http://tom-e-white.com/covid-19-uk-data/) at UK level.^[http://tom-e-white.com/covid-19-uk-data/]